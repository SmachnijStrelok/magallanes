        ...
        if ($property === 'top') {
            ...
            if (is_array($this->hostConfig) && isset($this->hostConfig['extras'])) {
                if (isset($this->hostConfig['extras'][$option])) {
                    return $this->hostConfig['extras'][$option];
                }
            }

            // Global Config
            $config = $this->getEnvironmentOption('extras', array());
            if (isset($config[$option])) {
                if (is_array($default) && ($config[$option] == '')) {
                    return $default;
                } else {
            ...
            if (is_array($this->hostConfig) && isset($this->hostConfig['extras'][$option])) {
                if (isset($this->hostConfig['extras'][$option][$property])) {
                    return $this->hostConfig['extras'][$option][$property];
                }
            }
            ...
            if (isset($config[$option][$property])) {
                if (is_array($default) && ($config[$option][$property] == '')) {
                    return $default;
                } else {
